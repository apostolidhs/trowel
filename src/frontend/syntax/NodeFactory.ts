...
module trl.frontend.syntax {
    ...
    export class NodeFactory {
        ...
        constructor(
            ...
            private enableJSContextInfo: boolean
        ) { }
        ...
        public createProgram(body: IStatement[], loc?: lexical.ITokenSourceLocation, jscontext?: IJSContext): IProgram {
            const node = this.createNode({
                type: "Program",
                body
            }, loc);

            this.addJSContextInfoIfEnable(node, jscontext);
            return node;
        }
        ...
        public createDeclarationFunction(id: IIdentifier, params: IIdentifier[], body: IBlockStatement, loc?: lexical.ITokenSourceLocation, jscontext?: IJSContext): IFunctionDeclaration {
            const node = this.createNode({
        ...
        public createExpressionFunction(id: IIdentifier, params: IIdentifier[], body: IBlockStatement, loc?: lexical.ITokenSourceLocation, jscontext?: IJSContext): IFunctionExpression {
            const node = this.createNode({
        ...
        public addJSContextInfoIfEnable(node: IJSContextInfo, jscontext: IJSContext) {
            if (this.enableJSContextInfo) {
                node.jscontext = jscontext;
            }
        }
    }
